...
const Toast = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { style: {
            ...
            }, class: Object.assign(Object.assign(Object.assign({ [mode]: true }, theme.createColorClasses(this.color)), theme.getClassMap(this.cssClass)), { 'toast-translucent': this.translucent }), onIonToastWillDismiss: this.dispatchCancelHandler }, core.h("div", { class: wrapperClass }, core.h("div", { class: "toast-container", part: "container" }, this.renderButtons(startButtons, 'start'), core.h("div", { class: "toast-content" }, this.header !== undefined &&
            core.h("div", { class: "toast-header", part: "header" }, this.header), this.message !== undefined &&
            core.h("div", { class: "toast-message", part: "message", innerHTML: index.sanitizeDOMString(this.message) })), this.renderButtons(endButtons, 'end')))));
    }
