...
const Segment = class {
     ...
     */
    addRipple(detail) {
        const useRippleEffect = config.config.getBoolean('animated', true) && config.config.getBoolean('rippleEffect', true);
        if (!useRippleEffect) {
            return;
        }
        const buttons = this.getButtons();
...
const SegmentButton = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { "aria-disabled": disabled ? 'true' : null, class: {
                ...
                'ion-focusable': true,
            } }, core.h("button", { type: type, "aria-pressed": checked ? 'true' : null, class: "button-native", disabled: disabled }, core.h("span", { class: "button-inner" }, core.h("slot", null)), mode === 'md' && core.h("ion-ripple-effect", null)), core.h("div", { part: "indicator", class: {
