...
const index$1$1 = require('./index-b37fae49.js');
...
const Menu = class {
    ...
    async connectedCallback() {
        if (this.type === undefined) {
            this.type = config.config.get('menuType', 'overlay');
        }
        const el = this.el;
...
`);
        ...
        index$1$1.menuController._register(this);
    ...
    disconnectedCallback() {
        ...
        index$1$1.menuController._unregister(this);
        if (this.animation) {
    ...
    setOpen(shouldOpen, animated = true) {
        return index$1$1.menuController._setOpen(this, shouldOpen, animated);
    }
    ...
    async loadAnimation() {
        ...
        this.animation = await index$1$1.menuController._createAnimation(this.type, this);
    ...
    canStart(detail) {
        ...
        else if (index$1$1.menuController._getOpenSync()) {
            return false;
        }
    ...
    updateState() {
        ...
        if (!this.disabled) {
            index$1$1.menuController._setActiveMenu(this);
        }
...
const updateVisibility = async (menu) => {
    const menuEl = await index$1$1.menuController.get(menu);
...
const MenuButton = class {
    constructor(hostRef) {
        ...
        this.type = 'button';
        this.onClick = async () => {
            return index$1$1.menuController.toggle(this.menu);
        };
    }
    componentDidLoad() {
    ...
    render() {
        ...
        const menuIcon = config.config.get('menuIcon', mode === 'ios' ? 'menu-outline' : 'menu-sharp');
