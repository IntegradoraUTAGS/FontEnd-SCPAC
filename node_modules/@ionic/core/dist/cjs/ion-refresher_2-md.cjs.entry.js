...
const core = require('./core-b7730736.js');
const config = require('./config-03608b68.js');
const helpers = require('./helpers-5c4a2267.js');
const animation = require('./animation-518a651e.js');
const cubicBezier = require('./cubic-bezier-07b30068.js');
require('./index-09c58b36.js');
require('./index.cjs.js');
require('./constants-122d7f67.js');
require('./hardware-back-button-1be0db15.js');
require('./index-b37fae49.js');
require('./overlays-995ecf9e.js');
const index$2 = require('./index-b9f4651b.js');
const spinnerConfigs = require('./spinner-configs-5a6c374b.js');
...
const shouldUseNativeRefresher = (referenceEl, mode) => {
    ...
    return (pullingSpinner !== null &&
        ...
        ((mode === 'ios' && config.isPlatform('mobile') && referenceEl.style.webkitOverflowScrolling !== undefined) ||
            mode === 'md'));
};
...
const RefresherContent = class {
    ...
    componentWillLoad() {
        if (this.pullingIcon === undefined) {
            ...
            this.pullingIcon = config.config.get('refreshingIcon', mode === 'ios' && config.isPlatform('mobile') ? config.config.get('spinner', overflowRefresher) : 'circular');
        }
        if (this.refreshingSpinner === undefined) {
            const mode = core.getIonMode(this);
            this.refreshingSpinner = config.config.get('refreshingSpinner', config.config.get('spinner', mode === 'ios' ? 'lines' : 'circular'));
        }
    }
    render() {
        ...
        return (core.h(core.Host, { class: mode }, core.h("div", { class: "refresher-pulling" }, this.pullingIcon && hasSpinner &&
            ...
            core.h("div", { class: "refresher-pulling-text", innerHTML: index$2.sanitizeDOMString(this.pullingText) })), core.h("div", { class: "refresher-refreshing" }, this.refreshingSpinner &&
            core.h("div", { class: "refresher-refreshing-icon" }, core.h("ion-spinner", { name: this.refreshingSpinner })), this.refreshingText &&
            core.h("div", { class: "refresher-refreshing-text", innerHTML: index$2.sanitizeDOMString(this.refreshingText) }))));
    }
    get el() { return core.getElement(this); }
};
